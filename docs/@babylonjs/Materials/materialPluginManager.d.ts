...
export declare class MaterialPluginManager {
     ...
     * @internal
     */
    _addPlugin(plugin: MaterialPluginBase): void;
    /**
     * @internal
     */
     ...
     */
    getPlugin(name: string): Nullable<MaterialPluginBase>;
 ...
 */
export declare type PluginMaterialFactory = (material: Material) => Nullable<MaterialPluginBase>;
/**
