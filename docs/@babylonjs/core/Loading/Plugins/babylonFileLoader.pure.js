...
import { Camera, RegisterCamera } from "../../Cameras/camera.pure.js";
...
import { CubeTexture, CubeTextureCreateFromPrefilteredData, CubeTextureParse, RegisterCubeTexture } from "../../Materials/Textures/cubeTexture.pure.js";
import { HDRCubeTexture } from "../../Materials/Textures/hdrCubeTexture.pure.js";
import { RegisterTexture } from "../../Materials/Textures/texture.pure.js";
        ...
        if (parsedData.environmentTexture !== undefined && parsedData.environmentTexture !== null) {
            ...
            if (parsedData.environmentTextureType && parsedData.environmentTextureType === "BABYLON.HDRCubeTexture") {
                ...
                if (typeof parsedData.environmentTexture === "object") {
                    ...
                    const cubeTexture = CubeTextureCreateFromPrefilteredData((parsedData.environmentTexture.match(/https?:\/\//g) ? "" : rootUrl) + parsedData.environmentTexture, scene, parsedData.environmentTextureForcedExtension);
                    if (parsedData.environmentTextureRotationY) {
