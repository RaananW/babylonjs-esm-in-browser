...
let PointLight = (() => {
    ...
    let _get_shadowAngle_decorators;
    return _a = class PointLight extends _classSuper {
            /**
            ...
            constructor(name, position, scene, dontAddToScene) {
                ...
                this._shadowAngle = (__runInitializers(this, _instanceExtraInitializers), Math.PI / 2);
        ...
        (() => {
            ...
            _get_shadowAngle_decorators = [serialize()];
            __esDecorate(_a, null, _get_shadowAngle_decorators, { kind: "getter", name: "shadowAngle", static: false, private: false, access: { has: obj => "shadowAngle" in obj, get: obj => obj.shadowAngle }, metadata: _metadata }, null, _instanceExtraInitializers);
 ...
 */
export function RegisterPointLight() {
    if (_Registered) {
        return;
    }
    _Registered = true;
...
//# sourceMappingURL=pointLight.pure.js.map