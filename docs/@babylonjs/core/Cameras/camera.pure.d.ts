...
import { type CameraInputsManager } from "./cameraInputsManager.js";
...
import { type Ray } from "../Culling/ray.pure.js";
/**
 ...
 */
export declare function CameraParse(parsedCamera: any, scene: Scene): Camera;
export declare function RegisterCamera(): void;
