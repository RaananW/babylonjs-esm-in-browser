...
const _WebGPUUnavailableWarning = "WebXR Space Warp is unavailable with WebGPU XR because this runtime does not expose usable motion-vector/depth sub-images; the feature was disabled.";
/**
 ...
 */
export function RegisterWebXRSpaceWarp() {
    if (_Registered) {
        return;
    }
    _Registered = true;
...
//# sourceMappingURL=WebXRSpaceWarp.pure.js.map