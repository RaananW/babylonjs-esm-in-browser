...
export class WebXRRawCameraAccess extends WebXRAbstractFeature {
    ...
    attach(force) {
        if (this._xrSessionManager.scene.getEngine().isWebGPU) {
            return this._disableAutoAttach("WebXR Raw Camera Access is unavailable with WebGPU XR because camera images are exposed only by XRWebGLBinding; the feature was disabled.");
        }
...
//# sourceMappingURL=WebXRRawCameraAccess.pure.js.map