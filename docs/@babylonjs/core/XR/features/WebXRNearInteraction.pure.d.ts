...
import { type WebXRControllerPointerSelection } from "./WebXRControllerPointerSelection.pure.js";
 ...
 */
export declare function WebXRNearInteractionPickMeshWithSphere(mesh: AbstractMesh, sphere: BoundingSphere, skipBoundingInfo?: boolean): PickingInfo;
/**
 * Register side effects for webXRNearInteraction.
 * Safe to call multiple times; only the first call has an effect.
 */
export declare function RegisterWebXRNearInteraction(): void;
