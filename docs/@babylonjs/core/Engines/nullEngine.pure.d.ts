...
export declare class NullEngine extends Engine {
     ...
     */
    updateUniformBuffer(_uniformBuffer: DataBuffer, _elements: FloatArray, _offset?: number, _count?: number): void;
    /**
     ...
     */
    bindUniformBufferBase(_buffer: DataBuffer, _location: number, _name: string): void;
    /**
     ...
     */
    bindUniformBlock(_pipelineContext: IPipelineContext, _blockName: string, _index: number): void;
