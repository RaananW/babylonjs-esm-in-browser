...
export interface INativeEngine {
    ...
    initializeTexture(texture: NativeTexture, width: number, height: number, hasMips: boolean, format: number, renderTarget: boolean, srgb: boolean, samples: number, isCube?: boolean): void;
