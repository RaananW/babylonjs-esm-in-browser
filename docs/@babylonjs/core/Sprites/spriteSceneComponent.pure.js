...
import { Ray, CreatePickingRayInCameraSpace, CreatePickingRayInCameraSpaceToRef } from "../Culling/ray.core.js";
 ...
 */
export function RegisterSpriteSceneComponent() {
    if (_Registered) {
        return;
    }
    _Registered = true;
...
//# sourceMappingURL=spriteSceneComponent.pure.js.map