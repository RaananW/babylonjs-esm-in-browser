 ...
 * @returns a new TransformNode object parsed from the source provided.
 */
export declare function TransformNodeParse(parsedTransformNode: any, scene: Scene, rootUrl: string): TransformNode;
export declare function RegisterTransformNode(): void;
