...
let MathBlock = (() => {
    ...
    return _a = class MathBlock extends _classSuper {
            /**
            ...
            constructor(name) {
                 ...
                 */
                this.operation = __runInitializers(this, _operation_initializers, MathBlockOperations.Add);
 ...
 */
export function RegisterMathBlock() {
    if (_Registered) {
        return;
    }
    _Registered = true;
...
//# sourceMappingURL=mathBlock.pure.js.map