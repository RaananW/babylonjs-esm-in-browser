...
import { CreateTorusVertexData } from "../../../Builders/torusBuilder.pure.js";
...
let TorusBlock = (() => {
    ...
    return _a = class TorusBlock extends _classSuper {
            /**
 ...
 */
export function RegisterTorusBlock() {
    if (_Registered) {
        return;
    }
    _Registered = true;
...
//# sourceMappingURL=torusBlock.pure.js.map