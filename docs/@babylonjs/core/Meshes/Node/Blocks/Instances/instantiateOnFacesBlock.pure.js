...
let InstantiateOnFacesBlock = (() => {
    ...
    return _a = class InstantiateOnFacesBlock extends _classSuper {
            /**
...
export { InstantiateOnFacesBlock };
let _Registered = false;
/**
 * Register side effects for instantiateOnFacesBlock.
 * Safe to call multiple times; only the first call has an effect.
 */
export function RegisterInstantiateOnFacesBlock() {
    if (_Registered) {
        return;
    }
    _Registered = true;
...
//# sourceMappingURL=instantiateOnFacesBlock.pure.js.map