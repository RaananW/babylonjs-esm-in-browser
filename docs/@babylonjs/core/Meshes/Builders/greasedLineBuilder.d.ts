 ...
 */
export declare function CreateGreasedLine(name: string, options: GreasedLineMeshBuilderOptions, materialOptions?: Nullable<GreasedLineMaterialBuilderOptions>, scene?: Nullable<Scene>): import("../index.js").GreasedLineBaseMesh | GreasedLineMesh | GreasedLineRibbonMesh;
/**
