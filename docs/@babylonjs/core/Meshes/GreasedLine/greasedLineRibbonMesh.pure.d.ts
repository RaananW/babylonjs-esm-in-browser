...
export declare class GreasedLineRibbonMesh extends GreasedLineBaseMesh {
     ...
     */
    static DIRECTION_XY: import("../../index.js").DeepImmutableObject<Vector3>;
    /**
     * Direction which the line segment will be thickened if drawn on the XZ plane
     */
    static DIRECTION_XZ: import("../../index.js").DeepImmutableObject<Vector3>;
    /**
     * Direction which the line segment will be thickened if drawn on the YZ plane
     */
    static DIRECTION_YZ: import("../../index.js").DeepImmutableObject<Vector3>;
    private _paths;
 ...
 */
export declare function RegisterGreasedLineRibbonMesh(): void;
