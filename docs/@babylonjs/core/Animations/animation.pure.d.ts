...
import { type IEasingFunction, type EasingFunction } from "./easing.js";
import { Vector3, Quaternion, Vector2, Matrix } from "../Maths/math.vector.pure.js";
import { Color3, Color4 } from "../Maths/math.color.pure.js";
import { type DeepImmutable, type Nullable } from "../types.js";
import { type Scene } from "../scene.pure.js";
import { type IAnimationKey } from "./animationKey.js";
import { AnimationRange } from "./animationRange.js";
import { type AnimationEvent } from "./animationEvent.js";
import { Node } from "../node.js";
import { type IAnimatable } from "./animatable.interface.js";
import { Size } from "../Maths/math.size.js";
import { type Animatable } from "./animatable.pure.js";
import { type RuntimeAnimation } from "./runtimeAnimation.js";
...
export declare class Animation {
     ...
     */
    static InheritOriginalValueFromActiveAnimations: boolean;
    /**
 ...
 */
export declare function AnimationMakeAnimationAdditive(sourceAnimation: Animation, referenceFrame?: number, range?: string, cloneOriginal?: boolean, clonedName?: string): Animation;
/**
 * Convert the keyframes of an animation to be relative to a given reference frame.
 * @param sourceAnimation defines the Animation containing keyframes to convert
 ...
 */
export declare function AnimationMakeAnimationAdditive(sourceAnimation: Animation, options?: IMakeAnimationAdditiveOptions): Animation;
/**
 ...
 */
export declare function AnimationCreateAnimation(property: string, animationType: number, framePerSecond: number, easingFunction: EasingFunction): Animation;
/**
 ...
 */
export declare function AnimationCreateAndStartAnimation(name: string, target: any, targetProperty: string, framePerSecond: number, totalFrame: number, from: any, to: any, loopMode?: number, easingFunction?: EasingFunction, onAnimationEnd?: () => void, scene?: Scene): Nullable<Animatable>;
/**
 ...
 */
export declare function AnimationCreateAndStartHierarchyAnimation(name: string, node: Node, directDescendantsOnly: boolean, targetProperty: string, framePerSecond: number, totalFrame: number, from: any, to: any, loopMode?: number, easingFunction?: EasingFunction, onAnimationEnd?: () => void): Nullable<Animatable[]>;
/**
 ...
 */
export declare function AnimationCreateMergeAndStartAnimation(name: string, node: Node, targetProperty: string, framePerSecond: number, totalFrame: number, from: any, to: any, loopMode?: number, easingFunction?: EasingFunction, onAnimationEnd?: () => void): Nullable<Animatable>;
/**
 ...
 */
export declare function AnimationTransitionTo(property: string, targetValue: any, host: any, scene: Scene, frameRate: number, transition: Animation, duration: number, onAnimationEnd?: Nullable<() => void>, stopCurrent?: boolean, customKeys?: IAnimationKey[]): Nullable<Animatable>;
/**
 * Appends the serialized animations from the source animations
 * @param source Source containing the animations
 * @param destination Target to store the animations
 */
export declare function AnimationAppendSerializedAnimations(source: IAnimatable, destination: any): void;
/**
 * Parses an animation object and creates an animation
 * @param parsedAnimation Parsed animation object
 * @returns Animation object
 */
export declare function AnimationParse(parsedAnimation: any): Animation;
/**
 ...
 */
export declare function AnimationParseFromFileAsync(name: Nullable<string>, url: string): Promise<Animation | Array<Animation>>;
/**
 * Creates an animation or an array of animations from a snippet saved by the Inspector
 * @param snippetId defines the snippet to load
 * @returns a promise that will resolve to the new animation or a new array of animations
 */
export declare function AnimationParseFromSnippetAsync(this: typeof Animation | void, snippetId: string): Promise<Animation | Array<Animation>>;
/**
 * Creates an animation or an array of animations from a snippet saved by the Inspector
 ...
 * @returns a promise that will resolve to the new animation or a new array of animations
 */
export declare const AnimationCreateFromSnippetAsync: typeof AnimationParseFromSnippetAsync;
/**
 * Register side effects for animation.
 * Safe to call multiple times; only the first call has an effect.
 */
export declare function RegisterAnimation(): void;
