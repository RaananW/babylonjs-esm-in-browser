...
import { Matrix, Quaternion, Vector2, Vector3 } from "../Maths/math.vector.pure.js";
 ...
 */
export function GetVector2Slerp(a, b, c) {
 ...
 */
export function GetVector3Slerp(a, b, c) {
 ...
 */
export function GetQuaternionFromUpForward(up, forward) {
 ...
 */
export const QuaternionEulerAngleOrders = ["xyz", "xzy", "yxz", "yzx", "zxy", "zyx"];
/**
 ...
 */
export function GetQuaternionFromEulerAngles(order, x, y, z) {
