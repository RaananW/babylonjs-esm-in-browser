 ...
 */
export declare class FlowGraphSetAngularVelocityBlock extends FlowGraphExecutionBlockWithOutSignal {
    /**
     * Input connection: The physics body whose angular velocity will be set.
     */
    readonly body: FlowGraphDataConnection<PhysicsBody>;
    /**
     * Input connection: The angular velocity vector to set.
     */
 ...
 */
export declare function RegisterFlowGraphSetAngularVelocityBlock(): void;
