 ...
 */
export declare const FlowGraphDefaultEventReferencePrefix = "flowgraph://events/";
/**
 ...
 */
export declare function GetDefaultEventReference(key: string): string;
/**
 ...
 */
export declare function GetDefaultEventReferenceKey(reference: string): string | undefined;
/**
