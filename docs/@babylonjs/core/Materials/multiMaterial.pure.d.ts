 ...
 */
export declare function MultiMaterialParseMultiMaterial(parsedMultiMaterial: any, scene: Scene): MultiMaterial;
/**
 * Register side effects for multiMaterial.
 * Safe to call multiple times; only the first call has an effect.
 */
export declare function RegisterMultiMaterial(): void;
