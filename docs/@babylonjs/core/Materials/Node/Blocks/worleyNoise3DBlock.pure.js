...
let WorleyNoise3DBlock = (() => {
    var _a;
    let _classSuper = NodeMaterialBlock;
    let _manhattanDistance_decorators;
    let _manhattanDistance_initializers = [];
    let _manhattanDistance_extraInitializers = [];
    return _a = class WorleyNoise3DBlock extends _classSuper {
            /**
            ...
            constructor(name) {
                ...
                this.manhattanDistance = __runInitializers(this, _manhattanDistance_initializers, false);
                __runInitializers(this, _manhattanDistance_extraInitializers);
        ...
        (() => {
            ...
            _manhattanDistance_decorators = [editableInPropertyPage("Use Manhattan Distance", 0 /* PropertyTypeForEdition.Boolean */, "PROPERTIES", { embedded: true, notifiers: { update: false } })];
            __esDecorate(null, null, _manhattanDistance_decorators, { kind: "field", name: "manhattanDistance", static: false, private: false, access: { has: obj => "manhattanDistance" in obj, get: obj => obj.manhattanDistance, set: (obj, value) => { obj.manhattanDistance = value; } }, metadata: _metadata }, _manhattanDistance_initializers, _manhattanDistance_extraInitializers);
 ...
 */
export function RegisterWorleyNoise3DBlock() {
    if (_Registered) {
        return;
    }
    _Registered = true;
...
//# sourceMappingURL=worleyNoise3DBlock.pure.js.map