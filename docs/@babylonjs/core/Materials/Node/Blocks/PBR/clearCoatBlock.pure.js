...
let ClearCoatBlock = (() => {
    ...
    return _a = class ClearCoatBlock extends _classSuper {
            /**
            ...
            constructor(name) {
                 ...
                 */
                this.remapF0OnInterfaceChange = __runInitializers(this, _remapF0OnInterfaceChange_initializers, true);
                __runInitializers(this, _remapF0OnInterfaceChange_extraInitializers);
                this._isUnique = true;
                ...
                this.registerOutput("clearcoat", NodeMaterialBlockConnectionPointTypes.Object, NodeMaterialBlockTargets.Fragment, new NodeMaterialConnectionPointCustomObject("clearcoat", this, 1 /* NodeMaterialConnectionPointDirection.Output */, _a, "ClearCoatBlock"));
            }
            /**
        ...
        (() => {
            ...
            _remapF0OnInterfaceChange_decorators = [editableInPropertyPage("Remap F0 on interface change", 0 /* PropertyTypeForEdition.Boolean */, "ADVANCED", { embedded: true })];
            __esDecorate(null, null, _remapF0OnInterfaceChange_decorators, { kind: "field", name: "remapF0OnInterfaceChange", static: false, private: false, access: { has: obj => "remapF0OnInterfaceChange" in obj, get: obj => obj.remapF0OnInterfaceChange, set: (obj, value) => { obj.remapF0OnInterfaceChange = value; } }, metadata: _metadata }, _remapF0OnInterfaceChange_initializers, _remapF0OnInterfaceChange_extraInitializers);
