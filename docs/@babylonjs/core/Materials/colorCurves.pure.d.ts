 ...
 */
export declare function ColorCurvesParse(source: any): ColorCurves;
/**
 ...
 */
export declare function ColorCurvesBind(colorCurves: ColorCurves, effect: Effect, positiveUniform?: string, neutralUniform?: string, negativeUniform?: string): void;
/**
 * Register side effects for colorCurves.
 * Safe to call multiple times; only the first call has an effect.
 */
export declare function RegisterColorCurves(): void;
