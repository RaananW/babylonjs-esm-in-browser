...
import { GreasedLineMeshColorDistributionType, GreasedLineMeshColorMode, type GreasedLineMaterialOptions, type IGreasedLineMaterial } from "./greasedLineMaterialInterfaces.js";
/**
 * @internal
 */
 ...
 */
export declare function RegisterGreasedLinePluginMaterial(): void;
