 ...
 */
export declare function FresnelParametersParse(parsedFresnelParameters: IFresnelParametersSerialized): FresnelParameters;
/**
 * Register side effects for fresnelParameters.
 * Safe to call multiple times; only the first call has an effect.
 */
export declare function RegisterFresnelParameters(): void;
