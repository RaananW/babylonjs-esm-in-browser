 ...
 */
export function ColorGradingTextureParse(parsedTexture, scene) {
    let texture = null;
 ...
 */
export function RegisterColorGradingTexture() {
    if (_Registered) {
        return;
    }
    _Registered = true;
...
//# sourceMappingURL=colorGradingTexture.pure.js.map