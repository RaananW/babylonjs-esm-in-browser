 ...
 */
export declare function CubeTextureCreateFromImages(files: string[], scene: Scene, noMipmap?: boolean): CubeTexture;
/**
 ...
 */
export declare function CubeTextureCreateFromPrefilteredData(url: string, scene: Scene, forcedExtension?: any, createPolynomials?: boolean): CubeTexture;
/**
 ...
 * @returns a cube texture
 */
export declare function CubeTextureParse(parsedTexture: any, scene: Scene, rootUrl: string): CubeTexture;
/**
 * Register side effects for cubeTexture.
 * Safe to call multiple times; only the first call has an effect.
 */
export declare function RegisterCubeTexture(): void;
