...
import { type Effect, type IShaderPath } from "./effect.pure.js";
import { type ShaderLanguage } from "./shaderLanguage.js";
import { type UniformBuffer } from "./uniformBuffer.js";
import { type TextureSampler } from "./Textures/textureSampler.js";
import { type StorageBuffer } from "../Buffers/storageBuffer.js";
import { PushMaterial } from "./pushMaterial.js";
import { type ExternalTexture } from "./Textures/externalTexture.js";
import { type IColor3Like, type IColor4Like, type IVector2Like, type IVector3Like, type IVector4Like } from "../Maths/math.like.js";
 ...
 */
export declare function ShaderMaterialParse(source: any, scene: Scene, rootUrl: string): ShaderMaterial;
/**
 ...
 */
export declare function ShaderMaterialParseFromFileAsync(name: Nullable<string>, url: string, scene: Scene, rootUrl?: string): Promise<ShaderMaterial>;
/**
 ...
 * @returns a promise that will resolve to the new ShaderMaterial
 */
export declare function ShaderMaterialParseFromSnippetAsync(this: typeof ShaderMaterial | void, snippetId: string, scene: Scene, rootUrl?: string): Promise<ShaderMaterial>;
/**
 * Creates a ShaderMaterial from a snippet saved by the Inspector
 ...
 * @returns a promise that will resolve to the new ShaderMaterial
 */
export declare const ShaderMaterialCreateFromSnippetAsync: typeof ShaderMaterialParseFromSnippetAsync;
/**
 * Register side effects for shaderMaterial.
 * Safe to call multiple times; only the first call has an effect.
 */
export declare function RegisterShaderMaterial(): void;
