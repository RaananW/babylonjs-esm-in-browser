    ...
    static _Parse(parsedParticleSystem, particleSystem, sceneOrEngine, rootUrl) {
        ...
        if (internalClass && scene) {
            ...
            if (parsedParticleSystem.texture) {
                ...
                particleSystem.particleTexture = new internalClass(rootUrl + parsedParticleSystem.textureName, scene, false, parsedParticleSystem.invertY !== undefined ? parsedParticleSystem.invertY : true, textureSettings ? textureSettings.samplingMode : undefined);
    ...
    static _Serialize(serializationObject, particleSystem, serializeTexture) {
        ...
        if (particleSystem.particleTexture) {
            if (serializeTexture) {
                ...
                const particleTexture = particleSystem.particleTexture;
...
//# sourceMappingURL=particleSystem.pure.js.map