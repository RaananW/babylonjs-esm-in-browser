 ...
 */
export declare function DefaultRenderingPipelineParse(source: any, scene: Scene, rootUrl: string): DefaultRenderingPipeline;
/**
 * Register side effects for defaultRenderingPipeline.
 * Safe to call multiple times; only the first call has an effect.
 */
export declare function RegisterDefaultRenderingPipeline(): void;
