 ...
 */
export declare function SSRRenderingPipelineParse(source: any, scene: Scene, rootUrl: string): SSRRenderingPipeline;
/**
 * Register side effects for ssrRenderingPipeline.
 * Safe to call multiple times; only the first call has an effect.
 */
export declare function RegisterSsrRenderingPipeline(): void;
