 ...
 */
export declare function StandardRenderingPipelineParse(source: any, scene: Scene, rootUrl: string): StandardRenderingPipeline;
/**
 * Register side effects for standardRenderingPipeline.
 * Safe to call multiple times; only the first call has an effect.
 */
export declare function RegisterStandardRenderingPipeline(): void;
