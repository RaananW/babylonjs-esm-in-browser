 ...
 */
export declare function editableInPropertyPage(displayName: string, propertyType?: PropertyTypeForEdition, groupName?: string, options?: IEditablePropertyOption): (_value: unknown, context: {
    name: string | symbol;
 ...
 */
export declare function GetEditableProperties(target: any): IPropertyDescriptionForEdition[];
