...
import { Matrix, Vector2, Vector3 } from "./math.vector.pure.js";
/**
 ...
 */
export function TemperatureTintToXyz(temperatureKelvin, tint) {
 ...
 */
function ClampedAdaptationRatio(destComponent, sourceComponent) {
 ...
 */
function BradfordAdapt(sourceWhiteXYZ, destWhiteXYZ) {
 ...
 */
export function GetWhiteBalanceMatrix(temperatureKelvin, tint) {
...
//# sourceMappingURL=colorTemperature.functions.js.map