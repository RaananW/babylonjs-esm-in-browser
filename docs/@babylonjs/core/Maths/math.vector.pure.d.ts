...
import { type Viewport } from "./math.viewport.js";
import { type DeepImmutable, type Nullable, type FloatArray, type float, type Tuple } from "../types.js";
import { type Plane } from "./math.plane.js";
import { type TransformNode } from "../Meshes/transformNode.pure.js";
import { type Dimension, type Tensor, type TensorLike, type TensorStatic } from "./tensor.js";
import { type IVector2Like, type IVector3Like, type IVector4Like, type IQuaternionLike, type IMatrixLike, type IPlaneLike, type IVector3LikeInternal } from "./math.like.js";
/**
 ...
 */
export declare function RegisterMathVector(): void;
