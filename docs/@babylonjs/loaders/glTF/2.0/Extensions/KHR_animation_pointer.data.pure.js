...
import { AnimationPropertyInfo, RegisterGLTFLoaderAnimation } from "../glTFLoaderAnimation.pure.js";
 ...
 * @internal
 */
export function _RegisterKHRAnimationPointerData() {
    if (_Registered) {
        return;
    }
    _Registered = true;
    ...
    SetInterpolationForKey("/materials/{}/occlusionTexture/strength", [
...
//# sourceMappingURL=KHR_animation_pointer.data.pure.js.map