import { AllocateShBuffers } from "@babylonjs/core/Meshes/GaussianSplatting/gaussianSplattingMeshBase.pure.js";
...
export async function ParseSogMetaAsTextures(dataOrFiles, rootUrl, scene, computeCpuPositions = true, downloadManager, downloadGroupId) {
    let data;
    let files;
    if (dataOrFiles instanceof Map) {
        files = dataOrFiles;
...
//# sourceMappingURL=sog.pure.js.map